...
export function buildColorModeBootScript(
  ...
  return `(function(){try{var k=${key};var d=${fallback};var v=localStorage.getItem(k);if(v!=='auto'&&v!=='light'&&v!=='dark')v=d;var dark=v==='dark'||(v==='auto'&&window.matchMedia('(prefers-color-scheme: dark)').matches);document.documentElement.dataset.theme=dark?'dark':'light';}catch(e){document.documentElement.dataset.theme=window.matchMedia('(prefers-color-scheme: dark)').matches?'dark':'light';}})();`
}
