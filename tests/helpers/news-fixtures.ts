...
export function newsDetailPage(
  ...
  return {
    ...
    contentType: 'news',
    url: {
      routePath: `/${locale}/article/${pkg.slug}/`,
      outputPath: `${locale}/article/${pkg.slug}/index.html`,
      publicPath: `/base/${locale}/article/${pkg.slug}/`,
      absoluteUrl: `https://synctrol.com/base/${locale}/article/${pkg.slug}/`,
    },
    isFallback: false,
    isDraft: false,
    noindex: false,
