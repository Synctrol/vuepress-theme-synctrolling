...
describe('LanguageSwitcher', () => {
  ...
  it('implements listbox keyboard navigation with aria-activedescendant', async () => {
    ...
    expect(listbox.attributes('aria-activedescendant')).toBe(zhId)

    await listbox.trigger('keydown', { key: 'ArrowDown' })
    expect(listbox.attributes('aria-activedescendant')).toBe(enId)

    await listbox.trigger('keydown', { key: 'ArrowDown' })
    expect(listbox.attributes('aria-activedescendant')).toBe(jaId)
